...
- `latexmk` and BibTeX complete without warnings, undefined references, underfull boxes, or overfull boxes.
- The final PDF has seven letter-size IEEE double-column pages.
