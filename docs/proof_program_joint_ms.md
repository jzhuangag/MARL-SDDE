...
## 6. Delayed Markov main theorem: proof obligations
...
## 8. Low-complexity estimator and controller
...
| Matrix-free exact lifted operator | derived; numerical audit pending |
